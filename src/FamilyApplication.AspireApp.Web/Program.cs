...
builder.Services.AddScoped<FamilyApplication.AspireApp.Web.Notifications.NotificationManager>();
builder.Services.AddScoped<NotificationManagerBase>(provider => provider.GetRequiredService<FamilyApplication.AspireApp.Web.Notifications.NotificationManager>());
